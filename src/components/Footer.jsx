        ...
        <footer className=" bg-secondary text-white p-10">
            <div className='footer sm:footer-horizontal w-[1320px] mx-auto'>
                <aside>
                    ...
                    <h6 className="footer-title mt-5">Social</h6>
                ...
                <nav>
                    ...
                    <p className="text-sm leading-6 flex gap-4">
                        <FaMapMarkerAlt className='text-accent text-xl' />
                        250/A Oval Street, Mount View,<br />
                        London, United Kingdom
                    </p>
                    <p className="mt-2 flex gap-4">
                        <FaRegEnvelope className='text-accent text-xl' />
                        <a href="mailto:support@example.com" className="link link-hover">support@example.com</a>
                    </p>
                    <p className="mt-2 flex gap-4">
                        <FaPhone className='text-accent text-xl' />
                        <a href="tel:+981234567890" className="link link-hover">+98 12345 67890</a>
                    </p>
