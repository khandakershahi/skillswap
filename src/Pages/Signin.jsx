...
import { Link, useLocation, useNavigate } from 'react-router'; // use react-router-dom instead of react-router
...
const Signin = () => {
    ...
    const [email, setEmail] = useState(''); // <-- use state instead of ref
                        ...
                        <fieldset className="fieldset">
                            ...
                            <div>
                                <Link to='/auth/signup' className="link link-hover font-semibold">
                                    Don't have account? <span className="text-accent">Sign-up</span>
                                </Link>
                            </div>
                        </fieldset>
                    </form>
